---
name: e2e-testing
description: "E2E testing skill: Playwright end-to-end testing guide. Use for core user flow testing, UI interaction validation, Page Object Model implementation."
