...
description: "Code exploration strategies for understanding unfamiliar codebases. Parent skill with two modes: isolated-research (quick, one-shot) and iterative-retrieval (deep, multi-round)."
...
```
参考 skills/isolated-research/SKILL.md
```
...
```
参考 skills/iterative-retrieval/SKILL.md
```
