...
description: "Progressive context retrieval pattern for complex codebase exploration. Use when single searches fail to find relevant context, or when exploring unfamiliar large codebases."
...
> 本技能是 `codebase-exploration` 的子策略，适用于复杂的多轮迭代探索。
...
| 场景          | 推荐组合                                |
| ------------- | --------------------------------------- |
| 复杂 Bug 调试 | iterative-retrieval → debugging         |
| 架构分析      | iterative-retrieval → isolated-research |
| 新功能实现    | iterative-retrieval → lead              |
| 安全审查      | iterative-retrieval → security-review   |
